...
(async()=>{
    ...
    try{
        ...
        const fetchProd1 = "SELECT * FROM prelimexam.mf_product WHERE name = '" + prod1 + "';";
        const fetchProd2 = "SELECT * FROM prelimexam.mf_product WHERE name = '" + prod2 + "';";
        const fetchProd3 = "SELECT * FROM prelimexam.mf_product WHERE name = '" + prod3 + "';";
        const poAdd = 'INSERT INTO prelimexam.mf_purchase_order(date, supp_no, cust_no, status) VALUES ($1,$2,$3,$4) RETURNING po_no;';
        const loAdd = 'INSERT INTO prelimexam.mf_line_item(name, total_price, quantity, po_no, prod_no, status) VALUES ($1,$2,$3,$4,$5,$6) RETURNING lo_no;';
